...
BEGIN
	...
	IF C_COLUMN_DEFAULT = 'CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'
	THEN
		SET @C_DIFF = (SELECT COLUMN_DIFF(C_TABLE_SCHEMA, C_TABLE_NAME, C_COLUMN_NAME,  C_IS_NULLABLE, C_COLUMN_TYPE, 'CURRENT_TIMESTAMP'));
	ELSE
	...
	THEN
		...
		THEN
			IF C_COLUMN_DEFAULT = 'CURRENT_TIMESTAMP' OR C_COLUMN_DEFAULT = 'CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'
			THEN
