...
BEGIN
	SET @INDEX_NAME = concat('pk_' ,C_TABLE_NAME ,'_' ,C_COLUMN_NAME);
	SET @INDEX_DEF = concat('ADD PRIMARY KEY(`',C_COLUMN_NAME ,'`)');
	CALL DML_INDEX(C_TABLE_SCHEMA, C_TABLE_NAME, @INDEX_NAME, @INDEX_DEF);
END 
$$
DELIMITER ;
...
BEGIN
	CALL DROP_INDEX(C_TABLE_SCHEMA, C_TABLE_NAME, concat('pk_' ,C_TABLE_NAME ,'_' ,C_COLUMN_NAME));
END 
$$
DELIMITER ;
...
BEGIN
	CALL DML_INDEX(C_TABLE_SCHEMA, C_TABLE_NAME, concat('uk_' ,C_TABLE_NAME ,'_' ,C_COLUMN_NAME), concat('ADD UNIQUE KEY(`' ,C_COLUMN_NAME ,'`)'));
END 
$$
DELIMITER ;
...
BEGIN
	CALL DROP_INDEX(C_TABLE_SCHEMA, C_TABLE_NAME, concat('uk_' ,C_TABLE_NAME ,'_' ,C_COLUMN_NAME));
END 
$$
DELIMITER ;
...
BEGIN
	CALL DML_INDEX(
		C_TABLE_SCHEMA, 
		C_TABLE_NAME, 
		concat('fk_' ,C_TABLE_NAME ,'_' ,C_COLUMN_NAME),
...
BEGIN
	CALL DROP_INDEX(C_TABLE_SCHEMA, C_TABLE_NAME, concat('fk_' ,C_TABLE_NAME ,'_' ,C_COLUMN_NAME)); 
END 
DELIMITER $$
...
BEGIN
	...
	CALL DML_COLUMN(C_TABLE_SCHEMA, C_TABLE_NAME, 'update_time', 'NO', 'TIMESTAMP', 'CURRENT_TIMESTAMP');
